...
const ModalContent = ({ children }: { children: ReactNode }) => {
  return (
    <div className="relative flex flex-col justify-end items-center rounded-t-3xl min-h-max w-full ">
      ...
      <div className="flex flex-col justify-start items-start w-full max-md:max-h-[600px] overflow-y-scroll">
        {children}
      </div>

      <div className="flex justify-center items-center w-full py-3 px-2 bg-white">
